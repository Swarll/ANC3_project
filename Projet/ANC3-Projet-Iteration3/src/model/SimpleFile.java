...
public class SimpleFile extends FileOrDirectory{
    ...
    public String toString()
    {
        if (this.getParent() != null)
            return (this.getParent().getName() + "   " + this.type + " : " + this.name + "   " + this.size + "   " + this.date + "   " + this.corresp+ " " + this.selected );
        else
            return (this.type + " : " + this.name + "   " + this.size + "   " + this.date + "   " + this.corresp + " " + this.selected + " ");
    }

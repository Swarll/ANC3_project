...
public class View{
    ...
    private void configureBoxe()
    {
        ...
        HBox hb = new HBox();
        hb.getChildren().addAll(orphan, same, partial_same, newer, older, swap);
        hb.setSpacing(10);
    ...
    private void configureSwapButton(){
        ImageView folder1 = new ImageView(new Image(getClass().getResourceAsStream("./fleche.png")));
	swap.setGraphic(folder1);
        swap.setOnAction((ActionEvent event) -> {
            this.vm.swap();
        });
    }
    ...
    private void configureBinding()
    {
        ...
        this.swap.disableProperty().bindBidirectional(this.vm.allButtonProperty());

...
public class Directory extends FileOrDirectory{
    ...
    public Directory(Directory d, String path, Directory p)
    {
        this.type = Type.D;
        this.path = path;
        this.name = new SimpleStringProperty(d.getName());
        this.size = new SimpleIntegerProperty(d.getSize());
        this.date = new Date(d.date.getTime());
        this.parent = p;
    ...
    String toString(int i)
    {
        ...
        return (this.parent.getName() + "   " +this.type + " : " + this.name.getValue() + "   " 
                + this.size.getValue() + "   " + this.date + "   " + this.corresp + "   " + this.selected.getValue() + " " + this.path + " " +str);
    }
